...
export const pastEvents: PastEvent[] = [
  {
    ...
    dateRange: "Date: May 1 - 3, 2026",
    topic: "One Health in Action: Bridging Animal, Human, and Environmental Health",
    description:
      "Our Guest Speakers 2026 brought together clinicians, researchers, and advocates exploring One Health in Action across animal, human, and environmental health.",
    highlights: [
      "Day 1: Friday, May 1",
